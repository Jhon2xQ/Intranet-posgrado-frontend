    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-neutral-50 dark:bg-neutral-900">
      <div className="card w-full max-w-md">
        <div className="text-center mb-8">
          <div className="mb-6">
            {/* Placeholder for UNSAAC logo */}
            <div className="w-20 h-20 mx-auto bg-unsaac-600 rounded-full flex items-center justify-center">
              <span className="text-white text-2xl font-bold">UNSAAC</span>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-500">
            © 2024 Universidad Nacional de San Antonio Abad del Cusco
          </p>
        </div>
      </div>
    </div>
