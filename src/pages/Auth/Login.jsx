    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-blue-100 dark:bg-[#110022]">
      <div className="card w-full max-w-md border-2 border-neutral-400">
        <div className="text-center mb-8">
          <div className="mb-6">
            <div className="max-w-40 max-h-40 mx-auto flex items-center justify-center">
              <img src={logoL} alt="Logo" className="w-full h-full object-contain" />
            </div>
          </div>
          <h1 className="text-2xl font-bold text-neutral-800 dark:text-neutral-100 mb-2">Intranet Estudiantes</h1>
          <p className="text-neutral-600 dark:text-neutral-300">Escuela de Posgrado UNSAAC</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-500">© 2025 Universidad Nacional de San Antonio Abad del Cusco</p>
        </div>
      </div>
    </div>
  );
